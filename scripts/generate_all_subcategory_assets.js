...
const masterSubcategories = [
  // ─── Home & Kitchen ───
  { slug: 'furniture', aliases: ['furnitures', 'sofas', 'beds'], title: 'Furniture & Decor', color1: '#0288D1', color2: '#26C6DA', icon: '🛋️', label: 'Furniture' },
  { slug: 'kitchen-appliances', aliases: ['appliances', 'mixers', 'blenders'], title: 'Kitchen Appliances', color1: '#E65100', color2: '#F57C00', icon: '📺', label: 'Appliances' },
  { slug: 'home-decor', aliases: ['decor', 'wall-art'], title: 'Home Decor', color1: '#8E2DE2', color2: '#4A00E0', icon: '✨', label: 'Home Decor' },
  { slug: 'lighting-lamps', aliases: ['lighting', 'lamps', 'pendant-lights'], title: 'Lighting & Lamps', color1: '#FBC02D', color2: '#FFA000', icon: '💡', label: 'Lighting & Lamps' },
  { slug: 'cookware', aliases: ['cookware-pots', 'pots-pans'], title: 'Cookware & Pots', color1: '#D32F2F', color2: '#FF5252', icon: '🥘', label: 'Cookware' },
  { slug: 'storage-containers', aliases: ['containers', 'boxes'], title: 'Storage & Containers', color1: '#388E3C', color2: '#4CAF50', icon: '📦', label: 'Containers' },
  { slug: 'dining-serveware', aliases: ['serveware', 'dining'], title: 'Dining & Serveware', color1: '#009688', color2: '#4DB6AC', icon: '🍽️', label: 'Dining & Serveware' },
  { slug: 'cleaning-essentials', aliases: ['mops-brooms', 'cleaning'], title: 'Cleaning Essentials', color1: '#1976D2', color2: '#42A5F5', icon: '🧹', label: 'Cleaning' },
  ...
  { slug: 'bio-fertilizers-compost', aliases: ['fertilizers-soil-boosters', 'fertilizers', 'bio-fertilizers'], title: 'Bio Fertilizers & Compost', color1: '#56AB2F', color2: '#A8E063', icon: '🪴', label: 'Bio Fertilizer' },
  ...
  { slug: 'farm-tools-equipment', aliases: ['irrigation-tools', 'farm-tools', 'tools', 'garden-tools'], title: 'Farm Hand Tools & Equipment', color1: '#424242', color2: '#757575', icon: '🛠️', label: 'Farm Tools' },
  ...
  { slug: 'incense-sticks-dhoop', aliases: ['agarbatti', 'dhoop-sticks', 'incense-sticks'], title: 'Incense Sticks & Dhoop', color1: '#8E2DE2', color2: '#4A00E0', icon: '🪔', label: 'Agarbatti' },
  { slug: 'diya-brass-oil-lamps', aliases: ['brass-diyas', 'oil-lamps', 'diyas-lamps'], title: 'Diya & Brass Oil Lamps', color1: '#F7971E', color2: '#FFD200', icon: '🕯️', label: 'Brass Diyas' },
  ...
  { slug: 'concentrates-squashes', aliases: ['squash', 'sharbat', 'concentrates', 'cold-pressed'], title: 'Concentrates & Squashes', color1: '#FF512F', color2: '#DD2476', icon: '🍹', label: 'Fruit Squashes' },
  ...
  { slug: 'hair-oils-shampoos', aliases: ['shampoos', 'hair-oils', 'haircare'], title: 'Hair Oils & Shampoos', color1: '#43E97B', color2: '#38F9D7', icon: '💆', label: 'Shampoos & Oils' },
  ...
  { slug: 'mens-grooming-shaving', aliases: ['shaving-kit', 'grooming', 'personal-care', 'makeup'], title: 'Men\'s Grooming & Shaving', color1: '#200122', color2: '#6F0000', icon: '🪒', label: 'Shaving Kits' },

  // ─── Footwear ───
  { slug: 'mens-shoes', aliases: ['casual-shoes', 'formal-shoes', 'mens-footwear'], title: 'Men\'s Shoes', color1: '#1F1C2C', color2: '#928DAB', icon: '👞', label: 'Men\'s Shoes' },
  { slug: 'womens-sandals-heels', aliases: ['heels', 'sandals', 'womens-footwear'], title: 'Women\'s Heels & Sandals', color1: '#FF9A9E', color2: '#FECFEF', icon: '👠', label: 'Heels & Sandals' },
  { slug: 'ethnic-juttis-kolhapuris', aliases: ['juttis', 'kolhapuri', 'traditional-mojaris'], title: 'Ethnic Juttis & Kolhapuris', color1: '#F7971E', color2: '#FFD200', icon: '🥿', label: 'Ethnic Juttis' },
  { slug: 'sports-running-shoes', aliases: ['running-shoes', 'sneakers', 'sports-shoes'], title: 'Sports & Running Shoes', color1: '#00C6FF', color2: '#0072FF', icon: '👟', label: 'Sports Shoes' },
  ...
  { slug: 'blended-garam-masala', aliases: ['garam-masala', 'blended-masalas'], title: 'Blended Garam Masala', color1: '#4776E6', color2: '#8E54E9', icon: '🥘', label: 'Garam Masala' },
  ...
  // ─── Fashion ───
  { slug: 'mens-wear', aliases: ['mens-clothing', 'mens-fashion'], title: 'Men\'s Wear', color1: '#3A1C71', color2: '#D76D77', icon: '👔', label: 'Men\'s Apparel' },
  { slug: 'womens-wear', aliases: ['womens-clothing', 'womens-fashion'], title: 'Women\'s Wear', color1: '#FF758C', color2: '#FF7EB3', icon: '👗', label: 'Women\'s Apparel' },
  ...
  { slug: 'kids-wear', aliases: ['kids-clothing', 'kids-fashion'], title: 'Kids Wear', color1: '#38EF7D', color2: '#11998E', icon: '👕', label: 'Kids Wear' },
  ...
  { slug: 'winter-seasonal-wear', aliases: ['jackets', 'sweaters', 'winterwear'], title: 'Winter & Seasonal Wear', color1: '#00C6FF', color2: '#0072FF', icon: '🧥', label: 'Winterwear' },

  // ─── Jewellery ───
  { slug: 'gold-jewellery', aliases: ['gold-necklace', 'necklaces'], title: 'Gold Jewellery', color1: '#FFD700', color2: '#FFA500', icon: '💍', label: 'Gold Jewelry' },
  { slug: 'silver-jewellery', aliases: ['silver-anklet', 'silver-earrings'], title: 'Silver Jewellery', color1: '#E0E0E0', color2: '#9E9E9E', icon: '🥈', label: 'Silver Jewelry' },
  ...
  { slug: 'gemstone-beaded-jewellery', aliases: ['gemstone-jewelry', 'bangles-bracelets'], title: 'Gemstone Jewellery', color1: '#00B4DB', color2: '#0083B0', icon: '🔮', label: 'Gemstone Jewelry' },

  // ─── Auto Accessories ───
  { slug: 'car-cleaning-care', aliases: ['car-shampoo', 'car-care'], title: 'Car Cleaning & Care', color1: '#0288D1', color2: '#4FC3F7', icon: '🚗', label: 'Car Care' },
  { slug: 'helmet-riding-gear', aliases: ['helmets', 'helmets-gear'], title: 'Helmet & Riding Gear', color1: '#212121', color2: '#757575', icon: '🪖', label: 'Helmets' },
  ...
  { slug: 'mobile-holders-chargers', aliases: ['car-charger', 'auto-gadgets'], title: 'Mobile Holders & Chargers', color1: '#1565C0', color2: '#64B5F6', icon: '📱', label: 'Auto Mounts' },
  ...
  { slug: 'homemade-ghee-butter', aliases: ['desi-ghee', 'homemade-ghee'], title: 'Homemade Ghee & Butter', color1: '#FBC02D', color2: '#FFF59D', icon: '🧈', label: 'Pure Ghee' },
  ...
  { slug: 'traditional-sweets', aliases: ['kaju-katli', 'ladoo', 'sweets-snacks'], title: 'Traditional Sweets', color1: '#FFA000', color2: '#FFD54F', icon: '🍬', label: 'Desi Sweets' },
  ...
  { slug: 'traditional-wheat-kurdai', aliases: ['wheat-kurdai', 'papads-kurdai'], title: 'Traditional Wheat Kurdai', color1: '#E65100', color2: '#FFCC80', icon: '🍥', label: 'Wheat Kurdai' },
  ...
  // ─── Electronics ───
  { slug: 'smartphones-mobiles', aliases: ['smartphones', 'mobiles', 'mobile-accessories'], title: 'Smartphones & Mobiles', color1: '#1976D2', color2: '#90CAF9', icon: '📱', label: 'Smartphones' },
  ...
  { slug: 'bluetooth-speakers-audio', aliases: ['speakers', 'audio-headphones', 'home-audio'], title: 'Bluetooth Speakers', color1: '#5E35B1', color2: '#B39DDB', icon: '🔊', label: 'Speakers' },
